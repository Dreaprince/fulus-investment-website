                        ...
                        <div className="contact-information">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <span className="text"><span>Stock Building, 125 Ladoke Akintola, Lagos, Nigeria</span></span>
                                </li>
                                <li>
                                    <span className="icon"><i className="ion-ios-telephone-outline" /></span>
                                    <span className="text"><a href="tel:1234567890">(234) 8033308232</a><a href="tel:1234567890">(234) 8095689068</a></span>
                                </li>
                                <li>
                                    <span className="icon"><i className="ion-ios-email-outline" /></span>
                                    <span className="text"><a href="mailto:info@example.com">fulusinvestment.com</a><a href="mailto:info@example.com">fulusinvestment@gmail.com</a></span>
                                </li>
                            </ul>
                        </div>
                        </div>
