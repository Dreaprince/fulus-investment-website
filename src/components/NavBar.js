                                ...
                                <div className="header-info-wrapper align-items-center">
                                    ...
                                    <div className="logo">
                                        <Link to = {`${process.env.PUBLIC_URL}/home-one`}>
                                            <img src="assets/img/logo/logo1.png" className="img-fluid" alt="Logo" />
                                        </Link>
                                    </div>
                                    {/* header contact info */}
                                    ...
                                    <div className="header-info-single-item">
                                        ...
                                        <p className="header-info-single-item__subtitle">+2348033308232</p>
                                        </div>
                                    </div>
                                    <div className="header-info-single-item">
                                        <div className="header-info-single-item__icon">
                                        ...
                                        <p className="header-info-single-item__subtitle">10B Ladoke Akintola,GRA. Ikeja</p>
                                        </div>
                                    </div>
                                    </div>
                                    {/* mobile menu */}
