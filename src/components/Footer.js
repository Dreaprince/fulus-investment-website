                            ...
                            <div className="row">
                                ...
                                <div className="footer-intro-wrapper">
                                    ...
                                    <a href={`${process.env.PUBLIC_URL}/home-one`}>
                                        <img src="assets/img/logo/logo1.png" className="img-fluid" alt="" />
                                    </a>
                                    </div>
                                ...
                                <div className="footer-widget mb-0">
                                    ...
                                    <ul className="contact-details">
                                        <li><span>P:</span>2348033308232</li>
                                        <li><span>F:</span>2348095689068</li>
                                        <li><span>E:</span>fulusinvestment@gmail.com</li>
                                    </ul>
                                    </div>
                                </div>
                                </div>
